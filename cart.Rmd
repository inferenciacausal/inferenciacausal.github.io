...
A continuación, podrás implementar un árbol de decisión, considerando todas las covariables para explicar $Y$. Comienza fijando el parámetro $minbucket$ en 10 y $cp$ en $0.001$. ¿Qué ocurre con la gráfica del árbol cuando varía el valor del ponderador de penalización.?
