...
A continuación, podrás implementar un árbol de decisión, considerando todas las covariables para explicar $Y$. Comienza fijando el parámetro $minbucket$ en 10 y $cp$ en $0.001$. Observa [en el siguiente enlace](https://a2ic.shinyapps.io/CART_g_1, target=\"_blank\"){target="_blank"} lo que ocurre con la gráfica del árbol cuando varía el valor del ponderador de penalización. 
...
Lo que haremos entonces será graficar el valor de $K-fold CV$ de evaluación para cada uno de los árboles generados por los valores de $cp$ y su número de nodos. [En el siguiente enlace](https://a2ic.shinyapps.io/CART_g_2, target=\"_blank\"){target="_blank"} puedes variar el número $K$ que quieras darle a la validación.
