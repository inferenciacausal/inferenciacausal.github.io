...
## Caso: percepciones sobre el gasto público y el Estado de Bienestar
...
La base de datos puedes descargarla [aquí](https://github.com/AndyFerver/IN4402/blob/2a00eecd73f963c62dd18c9e726f09b61df36988/welfarelabel.rar), y si necesitas descargar este tutorial en formato Rmd para verlo en tu computador de manera offline, puedes hacerlo desde [aquí](https://github.com/AndyFerver/IN4402/blob/1b224508b213f0699491a9d3683f092b593b21b9/het_po.rar).
...
```{r paso_3, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE}
...
```{r paso_4, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE}
train_fraction <- 0.80
n <- dim(df)[1]
...
¿Cuál es la proporción de individuos tratados en la muestra? (50%)




# **4. Estimando Heterogeneidad**
...
```{r paso_5}
#, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE}
cf <- causal_forest(
...
## Examinando la región de soporte común
...
```{r paso_6, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE, fig.show = 'hide'}
...
¿Existe región de soporte? (Sí)




## Estudiando la heterogeneidad
...
```{r paso_7, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE}
...
```{r paso_8, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE,  fig.show = 'hide'}
...
```{r paso_9, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE}
#Tabla
...
```{r paso_10, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE}
num_tiles <- 4 
...
```{r paso_11, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE}
...
```{r paso_12, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE}
...
```{r paso_13, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE,  fig.show = 'hide'}
...
```{r paso_14, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE}
tc <- test_calibration(cf)
tc
```

## Interpretaciones
Para estudiar el efecto de tratamiento con una covariable en particular, se puede utilizar la función *best_linera_projection()* para ver la magnitud de las pendientes. En este caso comenzaremos con la variable que indica si el sujeto en estudio está divorciado o no. ¿Cómo se interpreta este resultado?

```{r paso_15, echo=TRUE, exercise=FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE}
...
En cambio, si estuvieramos estudiando una política o programa, sería de interés poder diseñar un óptimo.
